...
前往[内存分配](/essential/impl/8.mem.md)文章了解go具体是如分配内存的。
...
- Event timelines for running goroutines
    ...
    - trace by proc：显示每一时刻在该处理器上运行的协程时间线
        ...
        ![](/images/essentail/pprof_5.png)

    - trace by thread：显示每一时刻在OS线程上运行的协程时间线

        ![](/images/essentail/pprof_6.png)

    - Goroutine analysis：展示每组主函数的协程相关统计信息

        ![](/images/essentail/pprof_7.png)
        
        ![](/images/essentail/pprof_8.png)
