import{_ as l,V as c,W as o,X as s,Y as n,Z as i,a0 as a,F as t}from"./framework-f06be456.js";const p="/images/essential/grammer_pkg.png",d={},r=a(`<h1 id="基本语法" tabindex="-1"><a class="header-anchor" href="#基本语法" aria-hidden="true">#</a> 基本语法</h1><p>Go的基本语法十分简洁且简单，下面通过一个简单的示例来进行讲解。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol>`,38);function b(g,h){const e=t("ExternalLinkIcon");return c(),o("div",null,[r,s("p",null,[n("下方列出所有的内置关键字，也可以前往"),s("a",u,[n("参考手册-标识符"),i(e)]),n("查看更多细节")]),v,s("p",null,[n("下面是Go语言中支持的运算符号的优先级排列，也可以前往"),s("a",m,[n("参考手册-运算符"),i(e)]),n("查看更多细节。")]),k])}const x=l(d,[["render",b],["__file","1.grammer.html.vue"]]);export{x as default};
