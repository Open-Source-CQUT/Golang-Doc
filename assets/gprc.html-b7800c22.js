...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在本例中，客户端建立好连接后，在调用远程方法时就跟调用本地方法一样，直接访问<code>client</code>的<code>Hello</code>方法并获取结果，这就是一个最简单的GRPC例子，许多开源的框架也都是对这一个流程进行了封装。</p><h2 id="bufbuild" tabindex="-1"><a class="header-anchor" href="#bufbuild" aria-hidden="true">#</a> bufbuild</h2><p>在上述例子中，是直接使用命令生成的代码，如果后期插件多了命令会显得相当繁琐，这时可以通过工具来进行管理protobuf文件，正好就有这么一个开源的管理工具<code>bufbuild/buf</code>。</p>`,36),y={href:"https://github.com/bufbuild/buf",target:"_blank",rel:"noopener noreferrer"},w={href:"https://buf.build/docs/installation",target:"_blank",rel:"noopener noreferrer"},x=e(`<p><strong>特点</strong></p><ul><li>BSR管理</li><li>Linter</li><li>代码生成</li><li>格式化</li><li>依赖管理</li></ul><p>有了这个工具可以相当方便的管理protobuf文件。</p><p>文档中提供了相当多的安装方式，可以自己选择。如果本地安装了go环境的话，直接使用<code>go install</code>安装即可</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ go <span class="token function">install</span> github.com/bufbuild/buf/cmd/buf@latest
...
trailer<span class="token punctuation">,</span> err <span class="token operator">:=</span> Stream<span class="token punctuation">.</span><span class="token function">Trailer</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="拦截器" tabindex="-1"><a class="header-anchor" href="#拦截器" aria-hidden="true">#</a> 拦截器</h2><h2 id="tls安全传输" tabindex="-1"><a class="header-anchor" href="#tls安全传输" aria-hidden="true">#</a> TLS安全传输</h2><h2 id="自定义认证" tabindex="-1"><a class="header-anchor" href="#自定义认证" aria-hidden="true">#</a> 自定义认证</h2>`,124);function S(C,M){const a=i("ExternalLinkIcon");return o(),c("div",null,[u,r,d,k,n("p",null,[s("官方网址："),n("a",v,[s("gRPC"),t(a)])]),n("p",null,[s("官方文档："),n("a",m,[s("Documentation | gRPC"),t(a)])]),n("p",null,[s("gRPC技术教程："),n("a",b,[s("Basics tutorial | Go | gRPC"),t(a)])]),n("p",null,[s("ProtocBuf官网："),n("a",g,[s("Reference Guides | Protocol Buffers Documentation (protobuf.dev)"),t(a)])]),q,n("p",null,[s("先下载Protocol Buffer编译器，下载地址："),n("a",f,[s("Releases · protocolbuffers/protobuf (github.com)"),t(a)])]),h,n("p",null,[s("开源地址："),n("a",y,[s("bufbuild/buf: A new way of working with Protocol Buffers. (github.com)"),t(a)])]),n("p",null,[s("文档地址："),n("a",w,[s("Buf - Install the Buf CLI"),t(a)])]),x])}const R=p(l,[["render",S],["__file","gprc.html.vue"]]);export{R as default};
