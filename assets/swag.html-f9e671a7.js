import{_ as t,V as i,W as o,X as n,Y as s,Z as e,a0 as p,F as c}from"./framework-f06be456.js";const l="/images/swag/example.png",u="/images/swag/auth.png",r="/images/swag/auth2.png",d={},g=n("h1",{id:"swag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#swag","aria-hidden":"true"},"#"),s(" swag")],-1),k=n("p",null,[s("swaggo/swag是Swagger API 2.0在go语言中的一个实现，通过在书写指定格式的注释就可以生成"),n("code",null,"swagger.json"),s("和"),n("code",null,"swagger.yaml"),s("类型的接口文档，方便导出和导入。")],-1),m={href:"https://github.com/swaggo/swag",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/swaggo/swag#readme",target:"_blank",rel:"noopener noreferrer"},b=n("p",null,"swag默认支持的web框架如下所示，本文以gin为例子，来演示gin结合swagger快速生成接口文档的例子。",-1),h={href:"http://github.com/swaggo/gin-swagger",target:"_blank",rel:"noopener noreferrer"},w={href:"http://github.com/swaggo/echo-swagger",target:"_blank",rel:"noopener noreferrer"},f={href:"https://github.com/swaggo/buffalo-swagger",target:"_blank",rel:"noopener noreferrer"},q={href:"https://github.com/swaggo/http-swagger",target:"_blank",rel:"noopener noreferrer"},x={href:"https://github.com/swaggo/http-swagger",target:"_blank",rel:"noopener noreferrer"},y={href:"https://github.com/swaggo/http-swagger",target:"_blank",rel:"noopener noreferrer"},_={href:"https://github.com/i-love-flamingo/swagger",target:"_blank",rel:"noopener noreferrer"},S={href:"https://github.com/gofiber/swagger",target:"_blank",rel:"noopener noreferrer"},j={href:"https://github.com/Nerzal/atreugo-swagger",target:"_blank",rel:"noopener noreferrer"},T={href:"https://github.com/hertz-contrib/swagger",target:"_blank",rel:"noopener noreferrer"},I={class:"hint-container tip"},A=n("p",{class:"hint-container-title"},"提示",-1),P={href:"https://swagger.io/docs/specification/about/",target:"_blank",rel:"noopener noreferrer"},N=p(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>首先下载swagger命令行工具</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go install github.com/swaggo/swag/cmd/swag@latest
...
<span class="token keyword">func</span> <span class="token function">Ping</span><span class="token punctuation">(</span>ctx <span class="token operator">*</span>gin<span class="token punctuation">.</span>Context<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行程序，访问<code>127.0.0.1/swagger/index.html</code>，界面如下</p><figure><img src="`+l+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>如此便运行起了一个基本的接口文档。接下来除了一些特别要注意的点，基本上和其他语言使用起来没有什么太大的差别。</p><h2 id="参数" tabindex="-1"><a class="header-anchor" href="#参数" aria-hidden="true">#</a> 参数</h2><p>定义参数的格式为</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@param name paramtype datatype isRequired comment
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+u+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>本质上这只是一个apikey，如果你传入的是bearer token的话，需要自己手动加上Bearer前缀。</p><figure><img src="'+r+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>然后在你需要认证的接口上加上如下注释</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// @security Bearer</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>其余生成的json和yaml文件可以方便在其他接口管理软件上导入数据。</p></li><li><p>注释写在哪里都一样，就算不写在函数上也一样能解析，只是写在函数上可读性好一些，本质上还是一个以注释形式和go源代码嵌在一起的DSL。</p></li><li><p>swag还支持很多其他的参数，可以使用<code>swag init -h</code>查看。</p></li></ol>`,72);function D(H,C){const a=c("ExternalLinkIcon");return i(),o("div",null,[g,k,n("p",null,[s("仓库："),n("a",m,[s("swaggo/swag: Automatically generate RESTful API documentation with Swagger 2.0 for Go. (github.com)"),e(a)])]),n("p",null,[s("文档："),n("a",v,[s("swaggo/swag: Automatically generate RESTful API documentation with Swagger 2.0 for Go. (github.com)"),e(a)])]),b,n("ul",null,[n("li",null,[n("a",h,[s("gin"),e(a)])]),n("li",null,[n("a",w,[s("echo"),e(a)])]),n("li",null,[n("a",f,[s("buffalo"),e(a)])]),n("li",null,[n("a",q,[s("net/http"),e(a)])]),n("li",null,[n("a",x,[s("gorilla/mux"),e(a)])]),n("li",null,[n("a",y,[s("go-chi/chi"),e(a)])]),n("li",null,[n("a",_,[s("flamingo"),e(a)])]),n("li",null,[n("a",S,[s("fiber"),e(a)])]),n("li",null,[n("a",j,[s("atreugo"),e(a)])]),n("li",null,[n("a",T,[s("hertz"),e(a)])])]),n("div",I,[A,n("p",null,[s("如果不熟悉swagger语法，可以前往"),n("a",P,[s("About Swagger Specification | Documentation | Swagger"),e(a)])])]),N])}const E=t(d,[["render",D],["__file","swag.html.vue"]]);export{E as default};
