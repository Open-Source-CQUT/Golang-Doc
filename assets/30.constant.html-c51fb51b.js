...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><br><p>虽然数字常量在Go语言中可以为任意精度，但是具体实现还是有以下限制：</p><ul><li>表示整型常量时至少有256 bits、</li><li>表示浮点数和复数时，尾数部分至少256 bits，二进制指数部分至少16 bits</li><li>当无法表示相应的精度时，浮点数会进行相应的舍入。</li><li>否则编译器会报错</li></ul>`,32);function _(x,N){const a=c("ExternalLinkIcon");return o(),t("div",null,[d,r,n("ul",null,[u,m,v,k,b,n("li",null,[s("还有一些并不适合基础教程，前往"),n("a",g,[s("参考手册-常量"),l(a)]),s("了解更多细节")])]),h])}const w=e(i,[["render",_],["__file","30.constant.html.vue"]]);export{w as default};
