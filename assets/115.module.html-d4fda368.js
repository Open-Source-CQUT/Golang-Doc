import{_ as c,V as d,W as p,X as s,Y as n,Z as a,$ as t,a0 as i,F as l}from"./framework-f06be456.js";const r="/images/essential/md_1.png",u="/images/essential/md_2.png",v="/images/essential/md_3.png",m="/images/essential/md_4.png",g="/images/essential/md_5.png",b="/images/essential/md_6.png",k="/images/essential/md_7.png",h="/images/essential/md_8.svg",f={},x=s("h1",{id:"模块",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#模块","aria-hidden":"true"},"#"),n(" 模块")],-1),y={href:"https://go.dev/ref/mod",target:"_blank",rel:"noopener noreferrer"},_=i('<br><h2 id="编写模块" tabindex="-1"><a class="header-anchor" href="#编写模块" aria-hidden="true">#</a> 编写模块</h2><p>Go Module本质上是基于VCS（版本控制系统），当你在下载依赖时，实际上执行的是VCS命令，比如<code>git</code>，所以如果你想要分享你编写的库，只需要做到以下三点：</p><ul><li>源代码仓库可公开访问，且VCS属于以下的其中之一 <ul><li>git</li><li>hg (Mercurial)</li><li>bzr (Bazaar)</li><li>svn</li><li>fossil</li></ul></li><li>是一个符合规范的go mod项目</li><li>符合语义化版本规范</li></ul><p>所以你只需要正常使用VCS开发，并为你的特定版本打上符合标准的Tag，其它人就可以通过模块名来下载你所编写的库，下面将通过示例来演示进行模块开发的几个步骤。</p>',5),w={href:"https://github.com/246859/hello",target:"_blank",rel:"noopener noreferrer"},q=i(`<h3 id="准备" tabindex="-1"><a class="header-anchor" href="#准备" aria-hidden="true">#</a> 准备</h3><p>在开始之前确保你的版本足以完全支持go mod（go &gt;= 1.17），并且启用了Go Module，通过如下命令来查看是否开启</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ go <span class="token function">env</span> GO111MODULE
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="创建" tabindex="-1"><a class="header-anchor" href="#创建" aria-hidden="true">#</a> 创建</h3><p>首先你需要一个可公网访问的源代码仓库，这个有很多选择，我比较推荐Github。在上面创建一个新项目，将其取名为hello，仓库名虽然没有什么特别限制，但建议还是不要使用特殊字符，因为这会影响到模块名。</p><img src="https://public-1308755698.cos.ap-chongqing.myqcloud.com//img/202404071341749.png" style="zoom:67%;"><p>创建完成后，可以看到仓库的URL是<code>https://github.com/246859/hello</code>，对应的go模块名就是<code>github.com/246859/hello</code>。</p><figure><img src="`+r+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>然后将其克隆到本地，通过<code>go mod init</code>命令初始化模块。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> clone git@github.com:246859/hello.git
...
hello jack<span class="token operator">!</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,45),G={href:"https://pkg.go.dev/",target:"_blank",rel:"noopener noreferrer"},E=s("figure",null,[s("img",{src:v,alt:"",tabindex:"0",loading:"lazy"}),s("figcaption")],-1),M={href:"https://pkg.go.dev/about#adding-a-package",target:"_blank",rel:"noopener noreferrer"},O={href:"https://pkg.go.dev/about#removing-a-package",target:"_blank",rel:"noopener noreferrer"},$=s("h2",{id:"设置代理",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#设置代理","aria-hidden":"true"},"#"),n(" 设置代理")],-1),C={href:"https://proxy.golang.org/",target:"_blank",rel:"noopener noreferrer"},D={href:"https://goproxy.io/zh/",target:"_blank",rel:"noopener noreferrer"},R={href:"https://goproxy.cn/",target:"_blank",rel:"noopener noreferrer"},A=i('<figure><img src="'+m+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>这里选择七牛云的代理，执行如下命令来修改Go代理，其中的<code>direct</code>表示代理下载失败后绕过代理缓存直接访问源代码仓库。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ go <span class="token function">env</span> <span class="token parameter variable">-w</span> <span class="token assign-left variable">GOPROXY</span><span class="token operator">=</span>https://goproxy.cn,direct
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>代理修改成功后，日后下载依赖就会非常的迅速。</p><br><h2 id="下载依赖" tabindex="-1"><a class="header-anchor" href="#下载依赖" aria-hidden="true">#</a> 下载依赖</h2>`,6),P={href:"https://pkg.go.dev/",target:"_blank",rel:"noopener noreferrer"},j=i('<h3 id="代码引用" tabindex="-1"><a class="header-anchor" href="#代码引用" aria-hidden="true">#</a> 代码引用</h3><p>在里面搜索著名的Web框架<code>Gin</code>。</p><figure><img src="'+g+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>这里会出现很多搜索结果，在使用第三方依赖时，需要结合引用次数和更新时间来决定是否采用该依赖，这里直接选择第一个</p><figure><img src="'+b+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>进入对应的页面后，可以看出这是该依赖的一个文档页面，有着非常多关于它的详细信息，后续查阅文档时也可以来这里。</p><figure><img src="'+k+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>这里只需要将它的地址复制下来，然后在之前创建的项目下使用<code>go get</code>命令，命令如下</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ go get github.com/gin-gonic/gin
...
hello.go
hello_test.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h3 id="版本选择" tabindex="-1"><a class="header-anchor" href="#版本选择" aria-hidden="true">#</a> 版本选择</h3><p>Go在依赖版本选择时，遵循<strong>最小版本选择原则</strong>。下面是一个官网给的例子，主模块引用了模块A的1.2版本和模块B的1.2版本，同时模块A的1.2版本引用了模块C的1.3版本，模块B的1.2版本引用了模块C的1.4版本，并且模块C的1.3和1.4版本都同时引用了模块D的1.2版本，根据最小可用版本原则，Go最终会选择的版本是A1.2，B1.2，C1.4和D1.2。其中淡蓝色的表示<code>go.mod</code>文件加载的，框选的表示最终选择的版本。</p><figure><img src="`+h+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',14),N={href:"https://go.dev/ref/mod#minimal-version-selection",target:"_blank",rel:"noopener noreferrer"},S=i(`<br><h3 id="go-mod" tabindex="-1"><a class="header-anchor" href="#go-mod" aria-hidden="true">#</a> go.mod</h3><p>每创建一个Go Mod项目都会生成一个<code>go.mod</code>文件，因此熟悉<code>go.mod</code>文件是非常有必要的，不过大部分情况并不需要手动的修改<code>go.mod</code>文件。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>module golearn
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通常情况下，该目录下一定有一个<code>list</code>文件，用于记录该依赖已知的版本号，而对于每一个版本而言，都会有如下的文件：</p><ul><li><code>zip</code>：依赖的源码压缩包</li><li><code>ziphash</code>：根据依赖压缩包所计算出的哈希值</li><li><code>info</code>：json格式的版本元数据</li><li><code>mod</code>：该版本的<code>go.mod</code>文件</li><li><code>lock</code>：临时文件，官方也没说干什么用的</li></ul>`,64),z=s("code",null,"go.mod",-1),I={href:"http://xn--sum-888fh76nzcya.golang.org",target:"_blank",rel:"noopener noreferrer"},U=s("code",null,"go.mod",-1),T=s("code",null,"go.sum",-1),B=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>github.com/bytedance/sonic v1.8.0 h1:ea0Xadu+sHlu7x5O3gKhRpQ1IKiMrSiHttPF0ybECuA=
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function Y(X,F){const e=l("ExternalLinkIcon"),o=l("RouterLink");return d(),p("div",null,[x,s("p",null,[n("每一个现代语言都会有属于自己的一个成熟的依赖管理工具，例如Java的Gradle，Python的Pip，NodeJs的Npm等，一个好的依赖管理工具可以为开发者省去不少时间并且可以提升开发效率。然而Go在早期并没有一个成熟的依赖管理解决方案，那时所有的代码都存放在GOPATH目录下，对于工程项目而言十分的不友好，版本混乱，依赖难以管理，为了解决这个问题，各大社区开发者百家争鸣，局面一时间混乱了起来，期间也不乏出现了一些佼佼者例如Vendor，直到Go1.11官方终于推出了Go Mod这款官方的依赖管理工具，结束了先前的混乱局面，并在后续的更新中不断完善，淘汰掉了曾经老旧的工具。时至今日，在撰写本文时，Go发行版本已经到了1.20，在今天几乎所有的Go项目都在采用Go Mod，所以在本文也只会介绍Go Mod，官方对于Go模块也编写了非常细致的文档："),s("a",y,[n("Go Modules Reference"),a(e)]),n("。")]),_,s("p",null,[n("示例仓库："),s("a",w,[n("246859/hello: say hello (github.com)"),a(e)])]),q,s("p",null,[n("当一个库被引用过后，"),s("a",G,[n("Go Package"),a(e)]),n("便会为其创建一个页面，这个过程是自动完成的，不需要开发者做什么工作，比如hello库就有一个专属的文档页面，如下图所示。")]),E,s("p",null,[n("关于上传模块的更多详细信息，前往"),s("a",M,[n("Add a package"),a(e)]),n("。")]),s("p",null,[n("关于如何删除模块的信息，前往"),s("a",O,[n("Removing a package"),a(e)]),n("。")]),$,s("p",null,[n("Go虽然没有像Maven Repo，PyPi，NPM这样类似的中央仓库，但是有一个官方的代理仓库："),s("a",C,[n("Go modules services (golang.org)"),a(e)]),n("，它会根据版本及模块名缓存开发者下载过的模块。不过由于其服务器部署在国外，访问速度对于国内的用户不甚友好，所以我们需要修改默认的模块代理地址，目前国内做的比较好的有以下几家：")]),s("ul",null,[s("li",null,[s("a",D,[n("GOPROXY.IO - 一个全球代理 为 Go 模块而生"),a(e)])]),s("li",null,[s("a",R,[n("七牛云 - Goproxy.cn"),a(e)])])]),A,s("p",null,[n("修改完代理后，接下来安装一个第三方依赖试试，Go官方有专门的依赖查询网站："),s("a",P,[n("Go Packages"),a(e)]),n("。")]),j,s("p",null,[n("前往"),a(o,{to:"/cmd.html#mod"},{default:t(()=>[n("go mod cmd")]),_:1}),n("了解命令的更多有关信息")]),H,s("p",null,[n("官网中还给出了"),s("a",N,[n("其他几个例子"),a(e)]),n("，大体意思都差不多。")]),S,s("p",null,[n("一般情况下，Go会计算压缩包和"),z,n("两个文件的哈希值，然后再根据GOSUMDB所指定的服务器（"),s("a",I,[n("默认是sum.golang.org"),a(e)]),n("）查询该依赖包的哈希值，如果本地计算出的哈希值与查询得到的结果不一致，那么就不会再向下执行。如果一致的话，就会更新"),U,n("文件，并向"),T,n("文件插入两条记录，大致如下：")]),B,s("p",null,[n("示例仓库："),s("a",V,[n("246859/work: go work example (github.com)"),a(e)])]),L,s("p",null,[n("前往"),a(o,{to:"/cmd.html#work"},{default:t(()=>[n("go work cmd")]),_:1}),n("了解命令的更多有关信息")]),W])}const K=c(f,[["render",Y],["__file","115.module.html.vue"]]);export{K as default};
