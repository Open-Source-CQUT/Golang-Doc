...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,18);function m(b,g){const t=l("RouterLink");return p(),c("div",null,[d,n("div",k,[r,n("p",null,[s("需要先了解"),o(t,{to:"/essential/senior/85.interface.html"},{default:i(()=>[s("接口教程")]),_:1})])]),v])}const y=e(u,[["render",m],["__file","80.method.html.vue"]]);export{y as default};
