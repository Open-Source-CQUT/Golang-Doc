...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>空结构体的使用场景有很多，比如之前提到过的，作为<code>map</code>的值类型，可以将<code>map</code>作为<code>set</code>来进行使用，又或者是作为通道的类型，即代表一个不发送数据的通道。</p>`,6);function q(_,x){const s=c("ExternalLinkIcon");return p(),o("div",null,[v,n("div",k,[m,g,n("ul",null,[n("li",null,[n("a",b,[a("BetterAlign"),e(s)])]),n("li",null,[n("a",h,[a("go-tools"),e(s)])])]),y]),f])}const P=i(r,[["render",q],["__file","70.struct.html.vue"]]);export{P as default};
